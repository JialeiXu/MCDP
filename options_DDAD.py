...
class DDAD_Options:
    def __init__(self):
        ...
        self.parser.add_argument('--json_file',type=str,
                                 default='./datasets/DDAD/new_mask_data.json')#new_data_Cam_01
        self.parser.add_argument('--json_file_val', type=str,
                                 default='./datasets/DDAD/new_mask_data_Cam_01.json')  # new_data_Cam_01
        self.parser.add_argument('--json_file_val_list', type=list,
                                 default=['./datasets/DDAD/new_mask_data_Cam_01.json',
                                          ])
        ...
        self.parser.add_argument('--save_local_files',type=list,default=['Camera.py','datasets/dataload_DDAD.py','eval.py','options_DDAD.py','self_sup.py','self_sup_loss.py',
                                                                         'train_DDAD.py','utils.py'])
        ...
        self.parser.add_argument('--train_camera_frame',default=[
            #-1,    0,  1
            [True,True,True],#l
            [True,True,True],#f
            [False,False,False]#r
        ...
        self.parser.add_argument('--val_step',type=int,default=20000)
